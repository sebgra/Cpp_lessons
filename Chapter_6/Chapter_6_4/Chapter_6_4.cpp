...
int main()
{
    ...
    enum DaysOfWeek // Dictionary like structure, first element value initialized at values zero, next are 1 incremented
    {
        Sunday = 0,
        Monday,
        Tuesday,
    ...
    int dayInput = Sunday; // Intialize to Sunday
    cin >> dayInput;
